...
void TestMain::SetRestartOnParticleParameterChange(bool value)
{
	particleParameter.SetRestartOnChange(value);
}

void TestMain::SetParticleParameters(const ParticleParameter::Definition * params, uint32 count)
{
	particleParameter.SetDefinition(params, count);
}
