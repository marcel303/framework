...
public:
	...
	virtual void DrawFlatPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color) = 0;
	...
	virtual void DrawParticles(const b2Vec2* positionBuffer, float32 radius, const b2ParticleColor* colorBuffer, int particleCount) = 0;
