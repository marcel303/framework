...
void DotDetector::treshold(const uint8_t * __restrict src, uint8_t * __restrict dst, const int sx, const int sy, const TresholdTest test, const uint8_t tresholdValue)
{
	// creste treshold mask
	
	const uint8_t * __restrict srcItr = src;
	      uint8_t * __restrict dstItr = dst;
