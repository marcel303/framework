...
#define SHKFacebookKey				@"78d8343c303ae4802b303f8a3d577bb0"
#define SHKFacebookSecret			@"8e36c2dce9a34e0a07acf9cce6bd2f07"
 ...
 */
#define SHKTwitterConsumerKey		@"NPMVNKB80bSwJrY2ydfxA"
#define SHKTwitterSecret			@"4FOk2SQUWdbzbwBHuLQZYnbxNQOvNQQOurl1wgYIM"
#define SHKTwitterCallbackUrl		@"http://www.grannies-games.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
