...
+ (void)sendWithText:(NSString*)text imageNamed:(NSString*)imageName linkedUrl:(NSString*)url
{
	[self sendWithSocialNotification:[[[OFSocialNotification alloc] initWithText:text imageNamed:imageName linkedUrl:url] autorelease]];
}
