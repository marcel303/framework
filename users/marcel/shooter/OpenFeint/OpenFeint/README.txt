...
********************************************************************************
**** What's New? (Version 2.5.1, 7.14.2010) 
********************************************************************************
- Unity support updated for iOS4
- A handful of bugfixes from 2.5

********************************************************************************
**** Integration Changes (Version 2.5.1, 7.14.2010)
********************************************************************************
- We recommend implementing your UIApplicationDelegate methods:
	- (void)applicationDidEnterBackground:(UIApplication *)application 
	- (void)applicationWillEnterForeground:(UIApplication *)application 
  These methods should at the very least invoke the corresponding methods in
  OpenFeint.h (example code in 'How To Use OpenFeint') to gracefully support
  the multitasking features introduced in iOS4.
