...
#define FILE(key, value) \
	...
	switch (sound)
	{
		FILE(Sound_Begin1, "begin1.wav");
		FILE(Sound_Bubble1, "bubble1.wav");
		FILE(Sound_Missile1, "missile1.wav");
		FILE(Sound_Missile2, "missile2.wav");
		FILE(Sound_Swarm1, "swarm1.wav");
		FILE(Sound_Swarm2, "swarm2.wav");
		FILE(Sound_Vulcan1, "vulcan1.wav");
		FILE(Sound_Vulcan2, "vulcan2.wav");
		FILE(Sound_Shockwave1, "shockwave1.wav");
		FILE(Sound_Shockwave2, "shockwave2.wav");
		FILE(Sound_Kill1, "kill1.wav");
		FILE(Sound_Damage1, "damage1.wav");
		FILE(Sound_Damage2, "damage2.wav");
		FILE(Sound_End1, "end1.wav");
