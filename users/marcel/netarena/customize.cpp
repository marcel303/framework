	...
	, m_buttonLegend(0)
{
	...
	for (int i = 0; i < MAX_CHARACTERS; ++i)
	{
		...
		m_characters[i] = new Button(x, y, portraitName, portraitName, 0, MAINMENU_BUTTON_FONT, MAINMENU_BUTTON_TEXT_X, MAINMENU_BUTTON_TEXT_Y, MAINMENU_BUTTON_TEXT_SIZE, MAINMENU_BUTTON_TEXT_COLOR);
	...
	, m_buttonLegend(0)
{
	...
	const int numSkins = characterData->getNumSkins();
	const int numEmblems = 4;

	const int buttonPosX = GFX_SX*1/4;

	m_back = new Button(0, 0, "mainmenu-button.png", "mainmenu-button.png", 0, MAINMENU_BUTTON_FONT, MAINMENU_BUTTON_TEXT_X, MAINMENU_BUTTON_TEXT_Y, MAINMENU_BUTTON_TEXT_SIZE, MAINMENU_BUTTON_TEXT_COLOR);
	m_effects = new Button(buttonPosX, GFX_SY/3, "mainmenu-button.png", "mainmenu-button.png", "menu-char-effects", MAINMENU_BUTTON_FONT, MAINMENU_BUTTON_TEXT_X, MAINMENU_BUTTON_TEXT_Y, MAINMENU_BUTTON_TEXT_SIZE, MAINMENU_BUTTON_TEXT_COLOR);
	...
	m_testGame = new Button(buttonPosX, GFX_SY/3 + 450, "mainmenu-button.png", "mainmenu-button.png", "menu-char-test", MAINMENU_BUTTON_FONT, MAINMENU_BUTTON_TEXT_X, MAINMENU_BUTTON_TEXT_Y, MAINMENU_BUTTON_TEXT_SIZE, MAINMENU_BUTTON_TEXT_COLOR);
