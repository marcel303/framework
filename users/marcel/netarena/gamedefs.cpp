...
OPTION_DEFINE(bool, GAMESTATE_LOBBY_STARTZONE_ENABLED, "Game State/Lobby/Start Zone Enabled");
...
OPTION_DEFINE(bool, GAMESTATE_ROUNDBEGIN_SHOW_CONTROLS, "Game State/Round Begin/Show Controls");
...
OPTION_DEFINE(float, PLAYER_SWORD_BALLHITSPEED_X, "Player/Attacks/Sword/Ball Hit Speed X");
OPTION_DEFINE(float, PLAYER_SWORD_BALLHITSPEED_Y, "Player/Attacks/Sword/Ball Hit Speed Y");
OPTION_STEP(PLAYER_SWORD_BALLHITSPEED_X, 0, 0, 10);
OPTION_STEP(PLAYER_SWORD_BALLHITSPEED_Y, 0, 0, 10);
...
OPTION_DEFINE(float, BULLET_SPRAY_SPEED, "Bullets/Spray/Speed");
OPTION_DEFINE(float, BULLET_SPRAY_BOUNCE_AMOUNT, "Bullets/Spray/Bounce Amount");
OPTION_DEFINE(float, BULLET_SPRAY_LIFE, "Bullets/Spray/Life");
...
OPTION_DEFINE(float, FOOTBRAWL_BALL_SPANW_TIME, "Game Modes/FootBrawl/Ball Spawn Time");
OPTION_DEFINE(float, FOOTBRAWL_BALL_POSSESSION_PLAYER_SPEED_MULTIPLIER, "Game Modes/FootBrawl/Ball Possession: Speed Multiplier");
OPTION_STEP(FOOTBRAWL_BALL_SPANW_TIME, 0, 1, .1f);
OPTION_STEP(FOOTBRAWL_BALL_POSSESSION_PLAYER_SPEED_MULTIPLIER, 0, 1, .02f);

OPTION_DEFINE(float, FOOTBALL_SCALE, "Game Objects/FootBall/Scale");
...
OPTION_DEFINE(float, FOOTBALL_DROP_DELAY, "Game Objects/FootBall/Pickup Delay On Drop");
OPTION_STEP(FOOTBALL_SCALE, 0, 0, .05f);
...
OPTION_DEFINE(int, FOOTBALL_GOAL_SIZE, "Game Objects/FootBall Goal/Size");
...
OPTION_DEFINE(bool, UI_TEXTCHAT_ENABLE, "UI/Text Chat/Text Chat Enabled");
