...
OPTION_DEFINE(float, PLAYER_DEATH_VIBRATION_DURATION, "Player/Vibration/Death Duration");
OPTION_DEFINE(float, PLAYER_DEATH_VIBRATION_STRENGTH, "Player/Vibration/Death Strength");
