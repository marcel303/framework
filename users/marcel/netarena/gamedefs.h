...
OPTION_DECLARE(int, PLAYER_JUMP_SPEED, 1875);
OPTION_DECLARE(int, PLAYER_WALLJUMP_SPEED, 1500);
OPTION_DECLARE(int, PLAYER_WALLJUMP_RECOIL_SPEED, 500);

OPTION_DECLARE(int, PLAYER_SWORD_COLLISION_X1, 20);
OPTION_DECLARE(int, PLAYER_SWORD_COLLISION_Y1, -100);
OPTION_DECLARE(int, PLAYER_SWORD_COLLISION_X2, 140);
OPTION_DECLARE(int, PLAYER_SWORD_COLLISION_Y2, -20);
OPTION_DECLARE(int, PLAYER_SWORD_PUSH_SPEED, 1200);

OPTION_DECLARE(int, STEERING_SPEED_ON_GROUND, 800);
OPTION_DECLARE(int, STEERING_SPEED_IN_AIR, 600);

OPTION_DECLARE(float, FRICTION_GROUNDED, 0.5f);

OPTION_DECLARE(float, GRAVITY, 6000.f);

OPTION_DECLARE(int, BLOCKTYPE_CONVEYOR_SPEED, 400);
