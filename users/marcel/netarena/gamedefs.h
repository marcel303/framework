...
OPTION_DECLARE(bool, PROTO_ENABLE_LEVEL_EVENTS, false);
...
OPTION_DECLARE(float, ROCKETPUNCH_CHARGE_MAX, 3.f);
...
OPTION_DECLARE(int, ROCKETPUNCH_DISTANCE_MIN, 1000);
OPTION_DECLARE(int, ROCKETPUNCH_DISTANCE_MAX, 1000);
