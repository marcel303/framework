...
OPTION_DECLARE(int, BULLET_BUBBLE_RADIUS_MIN, 80);
OPTION_DECLARE(int, BULLET_BUBBLE_RADIUS_MAX, 80);
OPTION_DECLARE(int, BULLET_BUBBLE_SPEED_MIN, 50);
OPTION_DECLARE(int, BULLET_BUBBLE_SPEED_MAX, 80);
...
OPTION_DECLARE(bool, GRAPPLE_ANALOG_AIM, true);
