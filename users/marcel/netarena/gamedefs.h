...
#define MAX_ARENA_SX (GFX_SX * 2 / BLOCK_SX) // 128
#define MAX_ARENA_SY (GFX_SY * 2 / BLOCK_SY) // 72

#define MAX_ARENA_SX_PIXELS (MAX_ARENA_SX * BLOCK_SX)
#define MAX_ARENA_SY_PIXELS (MAX_ARENA_SY * BLOCK_SY)
...
#define MAX_PARTICLE_EFFECTS 8
#define MAX_PORTALS 10
#define MAX_PICKUP_SPAWNERS 10
#define MAX_TILE_SPRITES 20
#define MAX_TILE_TRANSITIONS 10
#define MAX_DECALS 100
#define MAX_SCREEN_SHAKES 50
#define MAX_ZOOM_EFFECTS 4
#define MAX_LIGHT_EFFECTS 10
#define MAX_COINS 30
#define MAX_AXES (MAX_PLAYERS * 2)
#define MAX_PIPEBOMBS 10
#define MAX_BARRELS 10
#define MAX_FOOTBALLS 10
#define MAX_FOOTBALL_GOALS 2
...
#else
	OPTION_DECLARE(bool, USE_STEAMAPI, false);
#endif
...
OPTION_DECLARE(bool, GAMESTATE_LOBBY_STARTZONE_ENABLED, true);
OPTION_DECLARE(int, GAMESTATE_LOBBY_STARTZONE_X, 1590);
OPTION_DECLARE(int, GAMESTATE_LOBBY_STARTZONE_Y, 840);
OPTION_DECLARE(int, GAMESTATE_LOBBY_STARTZONE_SX, 270);
OPTION_DECLARE(int, GAMESTATE_LOBBY_STARTZONE_SY, 210);

OPTION_DECLARE(bool, GAMESTATE_ROUNDBEGIN_SHOW_CONTROLS, false);
...
OPTION_DECLARE(float, GAMESTATE_ROUNDCOMPLETE_SHOWWINNER_TIME, 1.f);
...
OPTION_DECLARE(int, MAX_CONSECUTIVE_ROUND_COUNT, 3);
...
OPTION_DECLARE(float, PLAYER_DEATH_ZOOM_FACTOR, 1.4f);
...
OPTION_DECLARE(float, PLAYER_FACING_ANIM_FRAMES, 7.f);
...
OPTION_DECLARE(bool, PLAYER_VS_PLAYER_COLLISION, false);
...
OPTION_DECLARE(float, PLAYER_SWORD_BALLHITSPEED_X, 800.f);
OPTION_DECLARE(float, PLAYER_SWORD_BALLHITSPEED_Y, 1200.f);
...
OPTION_DECLARE(float, SPRAYWEAPON_INITIAL_FILL, 3.f);
OPTION_DECLARE(float, SPRAYWEAPON_FIRING_INTERVAL, .05f);
OPTION_DECLARE(float, SPRAYWEAPON_PUSH_AMOUNT, .7f);

OPTION_DECLARE(float, PLAYER_WEAPON_GUN_COOLDOWN, 0.05f);
OPTION_DECLARE(float, PLAYER_WEAPON_GUN_KNOCKBACK, 100.f);
OPTION_DECLARE(float, PLAYER_WEAPON_ICE_COOLDOWN, 0.05f);
OPTION_DECLARE(float, PLAYER_WEAPON_ICE_KNOCKBACK, 100.f);
OPTION_DECLARE(float, PLAYER_WEAPON_BUBBLE_COOLDOWN, 0.05f);
OPTION_DECLARE(float, PLAYER_WEAPON_GRENADE_COOLDOWN, 0.05f);
OPTION_DECLARE(float, PLAYER_WEAPON_GRENADE_KNOCKBACK, 100.f);
...
OPTION_DECLARE(float, AIM_ANALOG_TRESHOLD, .1f);

OPTION_DECLARE(int, PLAYER_WALLSLIDE_SPEED, 150);
OPTION_DECLARE(int, PLAYER_WALLSLIDE_FX_INTERVAL, 16);

OPTION_DECLARE(int, PLAYER_SKIN_OVERRIDE, -1);

OPTION_DECLARE(float, BACKGROUND_ZOOM_MULTIPLIER, .5f);
...
OPTION_DECLARE(float, BULLET_DEFAULT_GRAVITY_MULTIPLIER, -.8f);

OPTION_DECLARE(int,  BULLET_TYPE0_MAX_WRAP_COUNT, 1);
OPTION_DECLARE(int,  BULLET_TYPE0_MAX_REFLECT_COUNT, 0);
OPTION_DECLARE(int,  BULLET_TYPE0_MAX_DISTANCE_TRAVELLED, GFX_SX);
...
OPTION_DECLARE(float, BULLET_BUBBLE_PLAYERSPEED_MULTIPLIER, .1f);

OPTION_DECLARE(int, BULLET_BLOOD_COUNT, 10);
OPTION_DECLARE(float, BULLET_BLOOD_LIFE, 2.5f);
OPTION_DECLARE(int, BULLET_BLOOD_SPEED_MIN, 500);
OPTION_DECLARE(int, BULLET_BLOOD_SPEED_MAX, 1000);

OPTION_DECLARE(float, BULLET_SPRAY_SPEED, 700.f);
OPTION_DECLARE(float, BULLET_SPRAY_BOUNCE_AMOUNT, 0.4f);
OPTION_DECLARE(float, BULLET_SPRAY_LIFE, 1.f);
...
OPTION_DECLARE(int, PICKUP_LIGHT_OFFSET_Y, -20);
OPTION_DECLARE(float, PICKUP_DROP_DELAY, .25f);

#define PICKUP_SPRITE_SX 60
#define PICKUP_SPRITE_SY 40

OPTION_DECLARE(int, PICKUP_GUN_COUNT, 1);
OPTION_DECLARE(int, PICKUP_GUN_WEIGHT, 10);
OPTION_DECLARE(int, PICKUP_NADE_WEIGHT, 10);
OPTION_DECLARE(int, PICKUP_SHIELD_WEIGHT, 10);
OPTION_DECLARE(int, PICKUP_ICE_COUNT, 1);
...
OPTION_DECLARE(int, ZOOM_PLAYER, -1);
OPTION_DECLARE(float, ZOOM_PLAYER_MAX_DISTANCE, 500.f);
OPTION_DECLARE(float, ZOOM_FACTOR_MIN, 1.f);
OPTION_DECLARE(float, ZOOM_FACTOR_MAX, 1.25f);
OPTION_DECLARE(float, ZOOM_FACTOR, 1.f);
OPTION_DECLARE(float, ZOOM_CONVERGE_SPEED, .02f);
...
OPTION_DECLARE(int, FOOTBRAWL_SCORE_LIMIT, -1);
OPTION_DECLARE(int, FOOTBRAWL_TIME_LIMIT, 60 * 2);
OPTION_DECLARE(float, FOOTBRAWL_BALL_SPANW_TIME, 3.f);
OPTION_DECLARE(float, FOOTBRAWL_BALL_POSSESSION_PLAYER_SPEED_MULTIPLIER, .75f);

OPTION_DECLARE(float, FOOTBALL_SCALE, .7f);
OPTION_DECLARE(int, FOOTBALL_FLEE_SPEED, 800);
OPTION_DECLARE(float, FOOTBALL_DROP_SPEED_MULTIPLIER, .5f);
OPTION_DECLARE(float, FOOTBALL_BOUNCINESS, .5f);
OPTION_DECLARE(int, FOOTBALL_BOUNCE_SOUND_TRESHOLD, 50);
OPTION_DECLARE(float, FOOTBALL_DROP_DELAY, .2f);

OPTION_DECLARE(int, FOOTBALL_GOAL_SIZE, 150);

OPTION_DECLARE(float, LIGHT_FLICKER_STRENGTH, .5f);
OPTION_DECLARE(int, LIGHT_FLICKER_FREQ_A, 3);
OPTION_DECLARE(int, LIGHT_FLICKER_FREQ_B, 5);
OPTION_DECLARE(int, LIGHT_FLICKER_FREQ_C, 7);
...
OPTION_DECLARE(float, PIPEBOMB_DEPLOY_TIME, 2.f);
...
#if ITCHIO_BUILD
OPTION_DECLARE(int, NINJADASH_DISTANCE_MAX, 250);
OPTION_DECLARE(int, NINJADASH_DISTANCE_MIN, 0);
#else
...
OPTION_DECLARE(int, DECAL_COUNT, 1);
OPTION_DECLARE(float, DECAL_SIZE_MIN, .1f);
OPTION_DECLARE(float, DECAL_SIZE_MAX, .2f);
OPTION_DECLARE(bool, DECAL_ENABLED, true);
OPTION_DECLARE(int, DECAL_COLOR, -1);

OPTION_DECLARE(float, FX_ATTACK_DUST_INTERVAL, 20.f);
OPTION_DECLARE(int, FX_ATTACK_DUST_PLAYER_SPEED_TRESHOLD, 50);

#define MAINMENU_BUTTON_FONT "font-menu-buttons.ttf"
OPTION_DECLARE(int, MAINMENU_BUTTON_TEXT_X, 70);
OPTION_DECLARE(int, MAINMENU_BUTTON_TEXT_Y, 30);
OPTION_DECLARE(int, MAINMENU_BUTTON_TEXT_SIZE, 42);
#define MAINMENU_BUTTON_TEXT_COLOR Color::fromHex("70ffff")

OPTION_DECLARE(int, CUSTOMIZEMENU_PORTRAIT_BASE_X, 510);
OPTION_DECLARE(int, CUSTOMIZEMENU_PORTRAIT_BASE_Y, 300);
OPTION_DECLARE(int, CUSTOMIZEMENU_PORTRAIT_SPACING_X, 300);
OPTION_DECLARE(int, CUSTOMIZEMENU_PORTRAIT_SPACING_Y, 300);

#ifdef DEBUG
OPTION_DECLARE(bool, UI_DEBUG_VISIBLE, true);
#else
OPTION_DECLARE(bool, UI_DEBUG_VISIBLE, false);
#endif

OPTION_DECLARE(bool, UI_LOBBY_LEAVEJOIN_ENABLE, false);
OPTION_DECLARE(bool, UI_LOBBY_GAMEMODE_SELECT_ENABLE, true);

OPTION_DECLARE(int, UI_BUTTONLEGEND_X, 100);
OPTION_DECLARE(int, UI_BUTTONLEGEND_Y, 940);
OPTION_DECLARE(int, UI_BUTTONLEGEND_FONT_SIZE, 36);
OPTION_DECLARE(int, UI_BUTTONLEGEND_ICON_SPACING, 10);
OPTION_DECLARE(int, UI_BUTTONLEGEND_TEXT_SPACING, 25);

OPTION_DECLARE(bool, UI_TEXTCHAT_ENABLE, true);
...
OPTION_DECLARE(int, UI_PLAYER_EMBLEM_TEXT_OFFSET_Y, -155);
