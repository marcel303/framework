...
void PlayerControl::RegisterParameters(Entity* entity)
{
	FASSERT(entity);

	entity->AddParameter(Parameter(PARAM_SPEEDF, "vf", REP_CONTINUOUS, COMPRESS_8_8, &m_controls.m_fAccel));
	entity->AddParameter(Parameter(PARAM_SPEEDF, "vs", REP_CONTINUOUS, COMPRESS_8_8, &m_controls.m_sAccel));
	entity->AddParameter(Parameter(PARAM_SPEEDF, "vv", REP_CONTINUOUS, COMPRESS_8_8, &m_controls.m_vAccel));
	entity->AddParameter(Parameter(PARAM_ROTF, "rx", REP_CONTINUOUS, COMPRESS_U16, &m_rotationX));
	entity->AddParameter(Parameter(PARAM_ROTF, "ry", REP_CONTINUOUS, COMPRESS_U16, &m_rotationY));
	entity->AddParameter(Parameter(PARAM_INT8, "firing", REP_ONCHANGE, COMPRESS_NONE, &m_controls.m_fire));
}
