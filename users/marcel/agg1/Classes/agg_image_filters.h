...
namespace agg
{
    ...
    {
        static float radius() { return 1.5; }
        static float calc_weight(float x)
        {
            float t;
    ...
    public:
        static float radius() { return 2.0; }
        static float calc_weight(float x)
        {
            return
                (1.0/6.0) * 
    ...
    public:
        image_filter_kaiser(float b = 6.33) :
            a(b), epsilon(1e-12)
        {
            i0a = 1.0 / bessel_i0(b);
        }
    ...
    public:
        image_filter_mitchell(float b = 1.0/3.0, float c = 1.0/3.0) :
            p0((6.0 - 2.0 * b) / 6.0),
    ...
    {
        static float radius() { return 3.2383; } 
        static float calc_weight(float x)
        {
    ...
    {
    public:
        image_filter_sinc(float r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float radius() const { return m_radius; }
        float calc_weight(float x) const
        {
            if(x == 0.0) return 1.0;
    ...
    {
    public:
        image_filter_lanczos(float r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float radius() const { return m_radius; }
        float calc_weight(float x) const
        {
           if(x == 0.0) return 1.0;
    ...
    {
    public:
        image_filter_blackman(float r) : m_radius(r < 2.0 ? 2.0 : r) {}
        float radius() const { return m_radius; }
        float calc_weight(float x) const
        {
           if(x == 0.0) return 1.0;
