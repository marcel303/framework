...
OPTION_DECLARE(int, COUNCIL_UI_AGENDAVIEWX, 130);
OPTION_DECLARE(int, COUNCIL_UI_AGENDAVIEWY, 200);


OPTION_DECLARE(int, COUNCIL_UI_AGENDAVIEWSX, 720);
OPTION_DECLARE(int, COUNCIL_UI_AGENDAVIEWSY, 40);
...
OPTION_DECLARE(int, ROUND_INCOME_X, 1465);
OPTION_DECLARE(int, ROUND_INCOME_Y, 964);
OPTION_DECLARE(int, ROUND_INCOME_DX, 119);

//

OPTION_DECLARE(int, SPEECH_BUBBLE_OFFSET_X, 0);
OPTION_DECLARE(int, SPEECH_BUBBLE_OFFSET_Y, -50);

//

OPTION_DECLARE(int, GOAL_KILL_WEIGHT, 3);
