...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        row_accessor(T* _buf, unsigned _width, unsigned _height, int _stride) :
            m_buf(0),
            m_start(0),
            m_width(0),
            m_height(0),
        ...
        void attach(T* _buf, unsigned _width, unsigned _height, int _stride)
        {
			...
			if(_stride < 0) 
            { 
				m_start = m_buf - int(_height - 1) * _stride;
			}
        }
    ...
    public:
        ...
        void attach(T* _buf, unsigned _width, unsigned _height, int _stride)
        {
            ...
            m_height = _height;
            m_stride = _stride;
            if(_height > m_rows.size())
            {
                m_rows.resize(_height);
            }
            ...
            if(_stride < 0)
            {
                _row_ptr = m_buf - int(_height - 1) * _stride;
            }
